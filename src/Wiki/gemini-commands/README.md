# CLI Commands![f61f10faddaaadea2e1a7e75a2352af2.png](../../_resources/f61f10faddaaadea2e1a7e75a2352af2.png)
        ...
        - **`save`**
            ...
            - **Details on Checkpoint Location:** The default locations for saved chat  
                ...
                - **Note:** These checkpoints are for manually saving and resuming  
                    ...
                    [Checkpointing documentation](/Applications/Joplin.app/Contents/Resources/cli/checkpointing.md "../cli/checkpointing.md").
        - **`resume`**
...
- **`/extensions`**
    ...
    - **Description:** Lists all active extensions in the current Gemini CLI  
        session. See [Gemini CLI Extensions](/Applications/Joplin.app/Contents/Resources/extensions/index.md "../extensions/index.md").
- **`/help`** (or **`/?`**)
...
- **`/memory`**
    ...
    - **Sub-commands:**
        ...
        - **Note:** For more details on how `GEMINI.md` files contribute to  
            ...
            [CLI Configuration documentation](/Applications/Joplin.app/Contents/Resources/get-started/configuration.md "../get-started/configuration.md").
- **`/restore`**
    ...
    - **Note:** Only available if the CLI is invoked with the `--checkpointing`  
        option or configured via [settings](/Applications/Joplin.app/Contents/Resources/get-started/configuration.md "../get-started/configuration.md"). See  
        [Checkpointing documentation](/Applications/Joplin.app/Contents/Resources/cli/checkpointing.md "../cli/checkpointing.md") for more details.
- **`/settings`**
...
- [**`/theme`**](/Applications/Joplin.app/Contents/Resources/app.asar/themes.md "./themes.md")
...
- **`/about`**
    ...
    - **Description:** Show version info. Please share this information when  
        filing issues.
- [**`/tools`**](/Applications/Joplin.app/Contents/Resources/tools/index.md "../tools/index.md")
...
please see the dedicated [Custom Commands documentation](/Applications/Joplin.app/Contents/Resources/app.asar/custom-commands.md "./custom-commands.md").
